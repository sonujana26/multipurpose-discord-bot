  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    let ls = client.settings.get(message.guild.id, "language")
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<a:red_arrow_right:1211951248501248011> **Name**', "```"+json.name+"```", true)
        .addField("<a:red_arrow_right:1211951248501248011> **Hex**",  "```"+json.hex+"```", true)
        .addField("<a:red_arrow_right:1211951248501248011> **RGB**",  "```"+json.rgb+"```", true)
        .addField(`<a:red_arrow_right:1211951248501248011> **${client.la[ls].cmds.info.color.brightershade}**`,  "```"+json.brightened +"```", true)
