  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      async function first_layer() {
        ...
        //define the embed
        let MenuEmbed = new MessageEmbed().setColor(es.color).setAuthor('Suggestion System', 'https://cdn3.emoji.gg/emojis/2635-ideateddy.png').setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-ticket"]["variable2"]))
        //send the menu msg
      ...
      client.settings.ensure(message.guild.id, {
        suggest: {
          ...
          statustext: `<a:loading:1205135543071940639> Waiting for Community Feedback, please vote!`,
          footertext: `Want to suggest / Feedback something? Simply type in this channel!`,
          approveemoji: `1204107381575917668`,
