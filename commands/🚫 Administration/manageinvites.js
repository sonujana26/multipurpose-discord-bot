...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      let menuoptions = [
        {
          ...
          emoji: "1212399330217173032" //optional
        },
        {
          value: "Remove Joins",
          ...
          emoji: "1212399553702269019" //optional
        },
        {
          value: "Add Fakes",
          ...
          emoji: "1212400040610496562" //optional
        },
        {
          value: "Remove Fakes",
        ...
        },
        {
          ...
          emoji: "1205381455505661952" //optional
        },
        {
          value: "Remove Leaves",
          ...
          emoji: "1205370640794787850" //optional
        },
        {
          value: "Cancel",
      ...
      .addField("**CURRENT INVITES:**", `<:like1:1212401057586483260> ${user} _**has invited __${realinvites} Member${realinvites != 1 ? "s": ""}__**_!`)
      ...
      async function menuselection(menu) {
        ...
        await menu?.reply({embeds : [new MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.la[ls].cmds.info.botfaq.menuembed.title, client.user.displayAvatarURL(), "https://discord.gg/theolympus69")
          ...
          message.reply({embeds : [new MessageEmbed()
            .setAuthor(`New Invites of: ${user.tag}`, user.displayAvatarURL({dynamic: true}), "https://discord.gg/theolympus69")
            .setColor(es.color).setThumbnail(es.thumb ? es.footericon && (es.footericon.includes("http://") || es.footericon.includes("https://")) ? es.footericon : client.user.displayAvatarURL() : null)
            .addField("\u200b", `<:like1:1212401057586483260> ${user} _**has invited __${realinvites} Member${realinvites != 1 ? "s": ""}__**_!`)
