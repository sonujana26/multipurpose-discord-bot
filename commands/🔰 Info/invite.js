...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      if(user) {
        if(!user.bot) return interaction?.reply({ephemeral: true, content: "<:cx_cross:1198077504599117834> You can't Invite a Normal user! **IT MUST BE A BOT**"})
        let button_public_invite = new MessageButton().setStyle('LINK').setLabel(handlemsg(client.la[ls].cmds.info.invite.buttons.public)).setURL("https://discord.com/api/oauth2/authorize?client_id=1097842300526284880&permissions=8&scope=bot")
...
.setImage("https://media.discordapp.net/attachments/588985630051139584/690175153069752364/animated-dividing-line-image-0111.gif")
            .setFooter(client.getFooter(`${user.username} | Olympus`, "https://imgur.com/SMu5DBC"))],
