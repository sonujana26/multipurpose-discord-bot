...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    let theemoji = "1198081535232983111";
    let MilratoGuild = client.guilds.cache.get("1195178425778982973");
    if (MilratoGuild) theemoji = "1198081535232983111";
      ...
      try {
        ...
        let menuoptions = [{
          ...
          },
          {
            ...
            description: `Manage the Emoji Settings for that Emoji`,
            emoji: "1167637063349321768"
          },
          {
            value: "Manage Emoji 4",
            description: `Manage the Emoji Settings for that Emoji`,
            emoji: "1167637099336441997"
          },
          {
            value: "Manage Emoji 5",
            description: `Manage the Emoji Settings for that Emoji`,
            emoji: "1167637165203804190"
          },
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(SetupNumber + " Apply Setup", "https://cdn3.emoji.gg/emojis/9615-partnernoteligible.png", "https://discord.gg/milrato")
            ...
            async function setup_with_channel_creation() {
              ...
              message.reply({
                embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor(es.color)
                  .setAuthor('Setting up...', 'https://cdn3.emoji.gg/emojis/2217-salesforce-load.gif')
                  .setFooter(client.getFooter(es))
                ]
              })
                              ...
                              if (counter === 25) {
                                message.reply({
                                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED")
                                    .setAuthor('You reached the maximum amount of Questions!', 'https://cdn3.emoji.gg/emojis/3220-warn-icon.png')
                                  ]
                                })
                                return ask_addrole();
                              }
                                ...
                                msg.channel.awaitMessages({
                                  ...
                                  if (collected.first().content.toLowerCase() === "no") {
                                    ...
                                    if (!message.guild.me.roles) return message.reply({
                                      embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable25"])).setAuthor("<:cx_cross:1198077504599117834> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                                        dynamic: true
                                      }))]
                                    })
            ...
            async function setup_without_channel_creation() {
              ...
              await pickmsg.channel.awaitMessages({filter: (m) => m.author.id === cmduser.id,
                  ...
                  if (channel) {
                    ...
                    throw "<:cx_cross:1198077504599117834> ERROR";
                  }
                })
                .catch(e => {
                  errored = e
                    ...
                    message.reply({
                      ...
                      msg.channel.awaitMessages({
                        ...
                        if (collected.first().content.toLowerCase() === "no") {
                          ...
                          if (!message.guild.me.roles) return message.reply({
                            embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable58"])).setAuthor("<:cx_cross:1198077504599117834> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                              dynamic: true
                            }))]
                          })
        ...
        case "acceptrole": {
          message.reply({
            ...
            msg.channel.awaitMessages({
              ...
              if (!message.guild.me.roles) return message.reply({
                embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable70"])).setAuthor("<:cx_cross:1198077504599117834> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                  dynamic: true
                }))]
              })
              ...
              if (guildrole.rawPosition <= botrole.rawPosition) {
                ...
                return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable71"])).setAuthor("<:cx_cross:1198077504599117834> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  }))]
                })
              }
          ...
          case "setrole": {
            message.reply({
              ...
              msg.channel.awaitMessages({
                ...
                if (!message.guild.me.roles) return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable81"])).setAuthor("<:cx_cross:1198077504599117834> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  }))]
                })
                ...
                if (guildrole.rawPosition <= botrole.rawPosition) {
                  ...
                  return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable82"])).setAuthor("<:cx_cross:1198077504599117834> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    }))]
                  })
                }
          ...
          case "setrole": {
            message.reply({
              ...
              msg.channel.awaitMessages({
                ...
                if (!message.guild.me.roles) return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable100"])).setAuthor("<:cx_cross:1198077504599117834> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  }))]
                })
                ...
                if (guildrole.rawPosition <= botrole.rawPosition) {
                  ...
                  return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable101"])).setAuthor("<:cx_cross:1198077504599117834> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    }))]
                  })
                }
          ...
          case "setrole": {
            message.reply({
              ...
              msg.channel.awaitMessages({
                ...
                if (!message.guild.me.roles) return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable119"])).setAuthor("<:cx_cross:1198077504599117834> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  }))]
                })
                ...
                if (guildrole.rawPosition <= botrole.rawPosition) {
                  ...
                  return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable120"])).setAuthor("<:cx_cross:1198077504599117834> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    }))]
                  })
                }
          ...
          case "setrole": {
            message.reply({
              ...
              msg.channel.awaitMessages({
                ...
                if (!message.guild.me.roles) return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable140"])).setAuthor("<:cx_cross:1198077504599117834> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  }))]
                })
                ...
                if (guildrole.rawPosition <= botrole.rawPosition) {
                  ...
                  return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable141"])).setAuthor("<:cx_cross:1198077504599117834> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    }))]
                  })
                }
          ...
          case "setrole": {
            message.reply({
              ...
              msg.channel.awaitMessages({
                ...
                if (!message.guild.me.roles) return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable161"])).setAuthor("<:cx_cross:1198077504599117834> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  }))]
                })
                ...
                if (guildrole.rawPosition <= botrole.rawPosition) {
                  ...
                  return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable162"])).setAuthor("<:cx_cross:1198077504599117834> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    }))]
                  })
                }
        ...
        case "temprole":
          message.reply({
            ...
            msg.channel.awaitMessages({
              ...
              if (!message.guild.me.roles) return message.reply({
                embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable183"])).setAuthor("<:cx_cross:1198077504599117834> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                  dynamic: true
                }))]
              })
              ...
              if (guildrole.rawPosition <= botrole.rawPosition) {
                ...
                return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable184"])).setAuthor("<:cx_cross:1198077504599117834> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  }))]
                })
              }
