  ...
  client.on("messageCreate", async (message) => {
    ...
    client.settings.ensure(message.guild.id, {
        suggest: {
          ...
          denymsg: `<:ml_cross:1204106928675102770> Thank you for the feedback, but we are not interested in this idea at this time.`,
          ...
          approveemoji: `1198077126939779102`,
          denyemoji: `1198077504599117834`,
        }
    });
