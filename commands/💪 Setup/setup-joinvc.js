              ...
              switch (optionhandletype){
                  ...
                  await tempmsg.channel.awaitMessages({filter: m => m.author.id === message.author.id,
                    ...
                    .then(collected => {
                      ...
                      try {
                        ...
                        return message.reply({embeds: [new Discord.MessageEmbed()
                          .setTitle(`<:cx_tick:1198077126939779102> I will now send Messages after someone joins the VC \`${Voicechannel.name}\` in the TextChannel **${Textchannel.name}**`)
                          .setColor(es.color)
                          .setFooter(client.getFooter(es))
                        ]});
                      } catch (e) {
                  ...
                  await tempmsg.channel.awaitMessages({filter: m => m.author.id === message.author.id,
                    ...
                    .then(collected => {
                      ...
                      try {
                        ...
                        return message.reply({embeds: [new Discord.MessageEmbed()
                          .setTitle(`<:cx_tick:1198077126939779102> Successfully removed **${Voicechannel.name}** out of the Setup!`)
                          .setColor(es.color)
                          .setFooter(client.getFooter(es))
                        ]});
                      } catch (e) {
                ...
                case "Show all VCS": {
                  ...
                  message.reply({embeds: [new Discord.MessageEmbed()
                    .setTitle(`<:cx_utility:1198081170257219647> Settings of the Join Vc-Messages System`)
                    .setColor(es.color)
            ...
            async function handle_the_picks2(optionhandletype, menuoptiondata) {
              switch (optionhandletype){
                  ...
                  await tempmsg.channel.awaitMessages({filter: m => m.author.id === message.author.id,
                    ...
                    .then(collected => {
                      ...
                      try {
                        ...
                        return message.reply({embeds: [new Discord.MessageEmbed()
                          .setTitle(`<:cx_tick:1198077126939779102> I will now Add the Role \`${Role.name}\` when someone joins the VC **${Discord.VoiceChannel.name}**`)
                          .setColor(es.color)
                          .setFooter(client.getFooter(es))
                        ]});
                      } catch (e) {
                ...
                case "Show all VCS": {
                  ...
                  message.reply({embeds: [new Discord.MessageEmbed()
                    .setTitle(`<:cx_utility:1198081170257219647> Settings of the Join Vc-Role System`)
                    .setColor(es.color)
