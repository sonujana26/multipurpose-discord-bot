...
module.exports = {
    ...
    try{
      ...
      async function first_layer(){
        ...
        .setColor(es.color)
        .setAuthor('Join-to-Create Setup', 'https://cdn3.emoji.gg/emojis/2947-join-icon.png')
      ...
      async function second_layer(SetupNumber, menuoptiondata)
      {
        ...
        let MenuEmbed = new Discord.MessageEmbed()
        .setColor(es.color)
        .setAuthor(client.getAuthor(SetupNumber + " Join-to-Create Setup", 'https://cdn3.emoji.gg/emojis/2947-join-icon.png'))
