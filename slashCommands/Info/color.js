  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    let color = options.getString("color");
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<:GreenArrow:1212593348280324156> **Name**', json.name, true)
        .addField("<:GreenArrow:1212593348280324156> **Hex**", json.hex, true)
        .addField("<:GreenArrow:1212593348280324156> **RGB**", json.rgb, true)
        .addField(`<:GreenArrow:1212593348280324156> **${client.la[ls].cmds.info.color.brightershade}**`, json.brightened, true)
