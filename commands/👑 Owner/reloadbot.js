...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      return message.reply({content : `<:ERROR:1198208490225815572> THIS COMMAND IS DISABLED\n\n\n> **Path:**
\`\`\`yml
${process.cwd()}
\`\`\`
> **Server:**
...
\`\`\``
      ...
      await tempmsg.edit({embeds: [new MessageEmbed()
        .setColor(es.color).setFooter(client.getFooter(es))
        .setAuthor(`Successfully Reloaded:`, `https://cdn.discordapp.com/emojis/1204107381575917668.gif?v=1`, `https://discord.gg/utmuExHwyT`)
