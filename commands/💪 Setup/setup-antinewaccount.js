        ...
        let menuoptions = [
          {
            ...
            emoji: !settings.enabled ? "1204107832232775730" : "1204107662392827904",
          },
          {
          ...
          case "Show Settings":
            {
              ...
              return message.reply({embeds: [new Discord.MessageEmbed()
                ...
                .setColor(es.color)
                .setDescription(`**Enabled:**\n> ${thesettings.enabled ? "<:enabled:1204107832232775730>" : "<:disabled:1204107662392827904>"}\n\n**Minimum Account Age:**\n> ${duration(thesettings.delay).map(i => `\`${i}\``).join(", ")}\n\n**Action:**\n> ${thesettings.action}`.substr(0, 2048))
                .addField(`**Current Extra-Message:**`, `${extramessage && extramessage.length > 1 ? extramessage : "No Extra Message provided"}`.substr(0, 1024))
                .setFooter(client.getFooter(es))
              ]});
            }
            ...
            let menuoptions = [
              {
                ...
                emoji: "1205326598362890320"
              },
              {
                value: "Ban",
                description: `Ban new Members`,
                emoji: "1205326770622959688"
              },
              {
                value: "Cancel",
                description: `Cancel and stop the Anti-New-Account-Setup!`,
