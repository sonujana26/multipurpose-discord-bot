  ...
  try {
    ...
    if (type.split(":")[1] === "add") {
      ...
      var embed2 = new MessageEmbed()
        ...
        .addField("<a:duration:1142776994711478302> Duration: ", `\`${res.tracks[0].isStream ? "LIVE STREAM" : format(res.tracks[0].duration)}\``, true)
        .addField("<a:song_by:1204110232381296701> Song By: ", `\`${res.tracks[0].author}\``, true)
        .addField("<:length:1205774052959068240> Queue length: ", `\`${player.queue.length} Songs\``, true)
    ...
    if (type.split(":")[1] === "search") {
      ...
      if (player.state !== "CONNECTED") {
        ...
        var embed = new MessageEmbed()
          ...
          .addField("<a:duration:1142776994711478302> Duration: ", `\`${track.isStream ? "LIVE STREAM" : format(track.duration)}\``, true)
          .addField("<a:song_by:1204110232381296701> Song By: ", `\`${track.author}\``, true)
          .addField("<:length:1205774052959068240> Queue length: ", `\`${player.queue.length} Songs\``, true)
