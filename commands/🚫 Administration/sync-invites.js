...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      let approve = new MessageButton().setStyle('SUCCESS').setCustomId('1').setEmoji("1212448034437210142").setLabel("YES DO IT!")
      let deny = new MessageButton().setStyle('PRIMARY').setCustomId('2').setEmoji("1212448060135841852").setLabel("Cancel")
