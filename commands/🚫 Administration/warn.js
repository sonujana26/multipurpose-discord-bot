    ...
    try {
      ...
      try {
        ...
        warnmember.send({embeds :[new MessageEmbed()
          ...
          .setFooter(client.getFooter(`You have: ${client.userProfiles.get(warnmember.user.id, 'warnings') ? client.userProfiles.get(warnmember.user.id, 'warnings').length : 0} Global Warns`, "https://cdn.discordapp.com/emojis/1198208227746259095.gif"))
        ...
        message.reply({embeds :[new MessageEmbed()
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon && (es.footericon.includes("http://") || es.footericon.includes("https://")) ? es.footericon : client.user.displayAvatarURL() : null)
          .setFooter(client.getFooter(`He has: ${client.userProfiles.get(warnmember.user.id, 'warnings') ? client.userProfiles.get(warnmember.user.id, 'warnings').length : 0} Global Warns`, "https://cdn.discordapp.com/emojis/1198208227746259095.gif"))
