        ...
        if (args[0].toLowerCase() === "start") {
            try{
                ...
                let options = {
                    ...
                    prize: `<a:giftt:1198080876345573437> ${giveawayPrize} <a:giftt:1198080876345573437>`,
                    ...
                    bonusEntries: [],
                    messages: {
                        inviteToParticipate: "***React with <a:Giveaways:1212391225362219068> to participate!***\n",
                        drawing: "> Ends: {timestamp}\n",
                        hostedBy: "**Hosted by:** {this.hostedBy}",
                        dropMessage: "Be the first to react with <a:Giveaways:1212391225362219068>",
                        noWinner: "\n**Giveaway cancelled!**\n> No valid participations. :cry:",
                        endedAt: "Ends at", 
                        giveaway: '<a:Giveaways:1212391225362219068> **GIVEAWAY STARTED** <a:Giveaways:1212391225362219068>',
                        giveawayEnded: '<a:Tada_Green:1212391831011336233> **GIVEAWAY ENDED** <a:Tada_Green:1212391831011336233>',
            ...
            client.giveawaysManager.reroll(giveaway.messageId, { winnerCount: !isNaN(args[1]) ? Number(args[1]) : 1})
                ...
                .catch((e) => {
                    if (e.startsWith(`Giveaway with message Id ${giveaway.messageId} is not ended.`)) {
                        ...
                        console.error(e);
                        message.reply({content : '<:cx_cross:1198077504599117834> **An error occured...**```' + String(e.message).substr(0, 1900) + "```"});
                    }
                });
