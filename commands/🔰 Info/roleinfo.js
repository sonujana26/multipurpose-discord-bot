  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {   
      ...
      if(!role || role == null || role.id == null || !role.id) return message.reply(client.la[ls].common.rolenotfound)
        ...
        embeduserinfo.addField(client.la[ls].cmds.info.roleinfo.field7,`\`${role.hoist ? "✅" : "❌"}\``,true)
        embeduserinfo.addField(client.la[ls].cmds.info.roleinfo.field8,`\`${role.mentionable ? "✅" : "❌"}\``,true)
