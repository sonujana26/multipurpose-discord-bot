...
///////////////////////////////////////
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          ...
          "https://cdn.discordapp.com/emojis/1198208227746259095.gif")
        ...
        switch(menuoptionindex){
          ...
          case 2: {
            ...
            return message.reply({embeds: [new Discord.MessageEmbed()
              ...
              .setColor(es.color)
              .setDescription(`**Enabled:** ${thesettings.enabled ? "<:enabled:1204107832232775730>" : "<:disabled:1204107662392827904>"}\n\n**Allowed Mentions / Message:** \`${thesettings.limit} Pings\``.substr(0, 2048))
              .setFooter(client.getFooter(es))]}
            );
          } break;
          case 3: {
