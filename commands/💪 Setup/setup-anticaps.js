...
///////////////////////////////////////
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          ...
          "https://media.discordapp.net/attachments/1205213675628273684/1205213723497603192/a-button-blood-type.png?ex=65d78dbf&is=65c518bf&hm=56b632f2d3a7eef13a170c928bb31dadc81e960cf8a751dcc22bc4528b0119ed&")
        ...
        collector.on('end', collected => {
          menumsg.edit({embeds: [menumsg.embeds[0].setDescription(`~~${menumsg.embeds[0].description}~~`)], components: [], content: `${collected && collected.first() && collected.first().values ? `<a:success:1198209588869222490> **Selected: \`${collected ? collected.first().values[0] : "Nothing"}\`**` : "❌ **NOTHING SELECTED - CANCELLED**" }`})
        });
      }
        ...
        switch(menuoptionindex){
          ...
          case 2: {
            ...
            return message.reply({embeds: [new Discord.MessageEmbed()
              ...
              .setColor(es.color)
              .setDescription(`**Enabled:** ${thesettings.enabled ? "<a:success:1198209588869222490>" : "<:cx_cross:1198077504599117834>"}\n\n**Percentage, of Message allowed to be in caps:** \`${thesettings.percent} %\``.substr(0, 2048))
              .setFooter(client.getFooter(es))]}
            );
          }
          case 3: {
