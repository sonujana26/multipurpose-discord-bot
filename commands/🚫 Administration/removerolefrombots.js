 ...
 module.exports = {
   ...
   aliases: [`roleremovebots`, "botroleremove", "role-remove-bots"],
     ...
     try {
      ...
      return message.reply({embeds : [new MessageEmbed()
       ...
       message.reply({embeds:  [new MessageEmbed()
         ...
         .setFooter(client.getFooter(es))
         .setAuthor(`Changing roles for ${members.length} Bots...`, "https://cdn.discordapp.com/emojis/1205135543071940639.gif")
