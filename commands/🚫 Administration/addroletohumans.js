 ...
 module.exports = {
   ...
   aliases: [`roleaddtohumans`, "add-role-to-humans", "rolehumans", "addrole2humans", "addrolehumans"],
     ...
     try {
      ...
      return message.reply({embeds : [new MessageEmbed()
       ...
       message.reply({embeds:  [new MessageEmbed()
         ...
         .setFooter(client.getFooter(es))
         .setAuthor(`Changing roles for ${members.length} Humans...`, "https://cdn.discordapp.com/emojis/1205135543071940639.gif")
