  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    if (customavatar) {
      let embed = new MessageEmbed()
        ...
        .addField("<:GreenArrow:1212593348280324156> PNG", `[\`LINK\`](${customavatar})`, true)
        .addField("<:GreenArrow:1212593348280324156> JPEG", `[\`LINK\`](${customavatar.replace("png", "jpg").replace("gif", "jpg")})`, true)
        .addField("<:GreenArrow:1212593348280324156> WEBP", `[\`LINK\`](${customavatar.replace("png", "webp").replace("gif", "webp")})`, true)
        .setURL(customavatar)
      ...
      let embed = new MessageEmbed()
        ...
        .setColor(es.color).setThumbnail(es.thumb ? es.footericon && (es.footericon.includes("http://") || es.footericon.includes("https://")) ? es.footericon : client.user.displayAvatarURL() : null)
        .addField("<:GreenArrow:1212593348280324156> PNG", `[\`LINK\`](${user.displayAvatarURL({format: "png"})})`, true)
        .addField("<:GreenArrow:1212593348280324156> JPEG", `[\`LINK\`](${user.displayAvatarURL({format: "jpg"})})`, true)
        .addField("<:GreenArrow:1212593348280324156> WEBP", `[\`LINK\`](${user.displayAvatarURL({format: "webp"})})`, true)
