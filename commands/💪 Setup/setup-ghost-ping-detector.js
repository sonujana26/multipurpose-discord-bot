    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor('Ghost-Ping-Detector Setup', 'https://cdn3.emoji.gg/emojis/1234-eyeterrifiedanimated.gif')
                  ...
                  if (channel) {
                    try {
                      ...
                      return message.reply({embeds: [new Discord.MessageEmbed()
                        .setTitle(`<:cx_tick:1198077126939779102> I will now send all detected Ghost Pings in \`${channel.name}\``)
                        .setColor(es.color)
