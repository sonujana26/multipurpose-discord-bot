          ...
          await tempmsg.channel.awaitMessages({
            ...
            .then(async collected => {
              try {
                ...
                message.reply({
                  embeds: [new Discord.MessageEmbed()
                    .setTitle(`<:cx_tick:1198077126939779102> Set the TWITTER USER ID TO: \`${collected.first().content}\``.substr(0, 256))
                ...
                await tempmsg.channel.awaitMessages({
                  ...
                  .then(async collected => {
                    try {
                      ...
                      return message.reply({
                        embeds: [new Discord.MessageEmbed()
                          .setTitle(`<:cx_tick:1198077126939779102> Set the TWITTER USER Name TO: \`${collected.first().content}\``.substr(0, 256))
