...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      if(!serverdata.verifychannel || serverdata.verifychannel.length < 5) return message.reply(`<:cx_cross:1198077504599117834> Verification System not setupped! An Admin can enable it via: \`${prefix}setup-epicgamesverify\``);
