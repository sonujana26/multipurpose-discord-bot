        ...
        async start() {
                ...
                if (player == 0) {
                        Embed = new MessageEmbed()
                                .setTitle(`<:Games:1204290758006407199> __**${authorName}**__ VS ${this.opponent.username} <:Games:1204290758006407199>`)
                                .setDescription(`It is ${authorName}'s Turn!`)
                                .setColor(3426654)
                } else {
                        Embed = new MessageEmbed()
                                .setTitle(`<:Games:1204290758006407199> ${authorName} VS __**${this.opponent.username}**__ <:Games:1204290758006407199>`)
                        ...
                        gameCollector.on('collect', async btn => {
                                if (btn.customId == a11 && gameData[player].member.id === btn.user.id) {
                                        ...
                                        if (btn.label == this.oEmoji || btn.label == this.xEmoji) { // User tries to place at an already claimed spot
                                                ...
                                                if (player == 0) {
                                                        Embed = new MessageEmbed()
                                                                .setDescription(`<:Games:1204290758006407199> __**${authorName}**__ VS ${this.opponent.username} <:Games:1204290758006407199>`)
                                                                .setColor(3426654)
                                                } else {
                                                        Embed = new MessageEmbed()
                                                                .setDescription(`<:Games:1204290758006407199> ${authorName} VS __**${this.opponent.username}**__ <:Games:1204290758006407199>`)
                                                                .setColor(3426654)
                                                }
                                        ...
                                        if (btn.label == this.oEmoji || btn.label == this.xEmoji) { // User tries to place at an already claimed spot
                                                ...
                                                if (player == 0) {
                                                        ...
                                                        Embed = new MessageEmbed()
                                                                .setDescription(`<:Games:1204444017014870056> ${authorName} VS __**${this.opponent.username}**__ <:Games:1204444017014870056>`)
                                                                .setColor(3426654)
                                                }
                                        ...
                                        if (btn.label == this.oEmoji || btn.label == this.xEmoji) { // User tries to place at an already claimed spot
                                                ...
                                                if (player == 0) {
                                                        Embed = new MessageEmbed()
                                                                .setDescription(`<:Games:1204444017014870056> __**${authorName}**__ VS ${this.opponent.username} <:Games:1204444017014870056>`)
                                                                .setColor(3426654)
                                                } else {
                                                        Embed = new MessageEmbed()
                                                                .setDescription(`<:Games:1204444017014870056> ${authorName} VS __**${this.opponent.username}**__ <:Games:1204444017014870056>`)
...
module.exports = {
        ...
        run: async (client, message, args, cmduser, text, prefix) => {
                ...
                new TicTacToe({
                        ...
                        xEmoji: '1204445827200974899', //Optional EMOJI / CustomEMOJI-ID
                        oEmoji: '1204445941378318356', //Optional EMOJI / CustomEMOJI-ID
                }).start();
                return;
        }
}