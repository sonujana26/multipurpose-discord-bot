 ...
 module.exports = {
   ...
   aliases: [`roleaddtoeveryone`, "add-role-to-everyone", "roleeveryone", "addrole2everyone", "addroleeveryone"],
   cooldown: 60,
     ...
     try {
      ...
      return message.reply({embeds : [new MessageEmbed()
       ...
       message.reply({embeds:  [new MessageEmbed()
         ...
         .setFooter(client.getFooter(es))
         .setAuthor(`Changing roles for ${members.length} Members...`, "https://cdn.discordapp.com/emojis/1205135543071940639.gif")
