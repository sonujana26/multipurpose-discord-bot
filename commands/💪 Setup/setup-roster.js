  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      async function first_layer(){
        ...
        .setColor(es.color)
        .setAuthor('Server Roster Setup', 'https://cdn3.emoji.gg/emojis/7406-pix.png')
      ...
      async function second_layer(SetupNumber, menuoptiondata){
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(SetupNumber + " Server Roster Setup", "https://cdn3.emoji.gg/emojis/7406-pix.png")
